        ...
        <?php   
		    if($_SESSION['logged_in'] == 0 )
		    {
                echo'
                    ...
                    <form action="login.php" method="post" autocomplete="off" style="background-color: white; border-style: solid; border-color: #52bad5; border-width: 10px; max-width: 340px; max-height: inherit; border-radius: 25px">
                    ...
                    <div class="g-recaptcha" data-sitekey="6LclYeMfAAAAALg0u25Q3MOxCPEj89fzkkjTvWaE"></div><br>
